...
const BookingsPage = () => {
  ...
  return (
    <div className="min-h-screen pb-24 md:max-w-5xl md:mx-auto">
      {/* Sticky header */}
      <header className="sticky top-0 z-20 bg-background/90 backdrop-blur-md px-5 pt-6 pb-2 border-b border-border/30">
      ...
      <div className="px-5 space-y-4 mt-1 md:grid md:grid-cols-2 md:gap-4 md:space-y-0">
